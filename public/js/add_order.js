...
addOrderForm.addEventListener("submit", function (e) {
    ...
    let inputRepValue = inputRepID.value;
    let inputClientValue = inputClientID.value;


    // Put our data we want to send in a javascript object
    let data = {
        repID: inputRepValue,
        clientID: inputClientValue,
    ...
    xhttp.onreadystatechange = () => {
        if (xhttp.readyState == 4 && xhttp.status == 200) {
            ...
            inputRepID.value = null;
            inputClientID.value = null;
...
addRowToTable = (data) => {
    ...
    clientIDCell.innerText = newRow.clientID;
